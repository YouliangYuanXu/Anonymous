...
def load_dataset(data_files):
    ...
    train_data, valid_data = {"text":[], "prefix":[]}, {"text":[], "prefix":[]}
    ...
    temp["column_names"] = Dataset.from_dict({"train":["text", "prefix"], "validation":["text", "prefix"]})
    temp["num_columns"] = Dataset.from_dict({"train":[2], "validation":[2]})
